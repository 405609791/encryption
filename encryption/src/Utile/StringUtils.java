...
public class StringUtils {
    ...
    public static String generateCode(String prefix,String code){
        ...
        builder.append("-");
        for (int i = 0; i < conut -prefixLength -1 - suffix.length() ; i++) {
            builder.append("0");
        }
     ...
     *
     * @param httpUrl
     *            http连接地址 比如"http://www.baidu.com/#wd=java"或者
     ...
     * @return
     */
    public static String getPrefixNumric6(String str)
    {
        if (isEmpty(str))
            return null;
        if (str.length() < 6)
            return null;
        String str6 = str.substring(0);
        if (isNumeric(str6))
            return str6;
        else
            return null;
     ...
     * @return
     */
    public static String getPrefixNumric4(String str)
    {
        if (isEmpty(str))
            return null;
        if (str.length() < 4)
